...
public interface Constant {
    ...
    String UNBAN_USER_SUCCESS = "UNBAN_USER_SUCCESS";
    String NOTIFICATION_ID_IS_REQUIRED = "NOTIFICATION_ID_IS_REQUIRED";
    String NOTIFICATION_NOT_FOUND = "NOTIFICATION_NOT_FOUND";
    String INVALID_BAN_REASON = "INVALID_BAN_REASON";
    String DELETE_NOTIFICATION_SUCCESS = "DELETE_NOTIFICATION_SUCCESS";
    String MARK_READ_NOTIFICATION_SUCCESS = "MARK_READ_NOTIFICATION_SUCCESS";
    String THIS_ACCOUNT_HAS_BEEN_BANNED = "THIS_ACCOUNT_HAS_BEEN_BANNED";
    String THIS_ACCOUNT_IS_ACTIVE = "THIS_ACCOUNT_IS_ACTIVE";
    ...
    String EXPECT_FIXING_DAY_MUST_START_AFTER_1_HOURS_AND_BEFORE_14_DAYS = "EXPECT_FIXING_DAY_MUST_START_AFTER_1_HOURS_AND_BEFORE_14_DAYS";
    ...
    String JUST_CAN_REJECT_CV_WHEN_CV_STATUS_IS_PENDING_OR_UPDATING = "JUST_CAN_REJECT_CV_WHEN_CV_STATUS_IS_PENDING_OR_UPDATING";
    String JUST_CAN_ACCEPT_CV_WHEN_CV_STATUS_IS_PENDING_OR_UPDATING = "JUST_CAN_ACCEPT_CV_WHEN_CV_STATUS_IS_PENDING_OR_UPDATING";
    String REJECT_CV_SUCCESS = "REJECT_CV_SUCCESS";
    String INVALID_REJECT_CV_STATUS = "INVALID_REJECT_CV_STATUS";
    String INVALID_CV_STATUS = "INVALID_CV_STATUS";
    ...
    String SERVICE_IS_INACTIVE = "SERVICE_IS_INACTIVE";
    ...
    String SUB_SERVICE_NAME_OF_THIS_SERVICE_IS_EXISTED = "SUB_SERVICE_NAME_OF_THIS_SERVICE_IS_EXISTED";
    ...
    String CATEGORY_NAME_EXISTED = "CATEGORY_NAME_EXISTED";
    String INVALID_INSPECTION_PRICE = "INVALID_INSPECTION_PRICE";
    String CATEGORY_NOT_FOUND = "CATEGORY_NOT_FOUND";
    String SERVICE_NAME_OF_THIS_CATEGORY_IS_EXISTED = "SERVICE_NAME_OF_THIS_CATEGORY_IS_EXISTED";
    ...
    String ACCESSORY_NAME_OF_THIS_SERVICE_IS_EXISTED = "ACCESSORY_NAME_OF_THIS_SERVICE_IS_EXISTED";
    ...
    String REQUEST_DOES_NOT_MATCHING_WITH_ANY_REPAIRER = "REQUEST_DOES_NOT_MATCHING_WITH_ANY_REPAIRER";
    ...
    String INVALID_DATE_TYPE = "INVALID_DATE_TYPE";
    String INVALID_QUERY_DATE = "INVALID_QUERY_DATE";
    String QUERY_DATE_AND_TYPE_NOT_MATCHED = "QUERY_DATE_AND_TYPE_NOT_MATCHED";
    String FROM_CAN_NOT_BE_GREATER_THAN_TO = "FROM_CAN_NOT_BE_GREATER_THAN_TO";
    ...
    String THIS_USER_CANNOT_CREATE_COMMENT_FOR_THIS_REQUEST = "THIS_USER_CANNOT_CREATE_COMMENT_FOR_THIS_REQUEST";
    ...
    String CAN_NOT_HAVE_MORE_THAN_5_REQUEST = "CAN_NOT_HAVE_MORE_THAN_5_REQUEST";
    ...
    String MAXIMUM_UPLOAD_SIZE_EXCEEDED = "MAXIMUM_UPLOAD_SIZE_EXCEEDED";
    ...
    String AMOUNT_MUST_BE_LOWER_OR_EQUAL_ = "AMOUNT_MUST_BE_LOWER_OR_EQUAL_";
    String INVALID_WITHDRAW_TYPE = "INVALID_WITHDRAW_TYPE";
    String BALANCE_NOT_ENOUGH = "BALANCE_NOT_ENOUGH";
    String AMOUNT_IS_REQUIRED = "AMOUNT_IS_REQUIRED";
    ...
    Map<String, String> VN_PAY_RESPONSE = new HashMap() {{
        ...
        put(REQUEST_DOES_NOT_MATCHING_WITH_ANY_REPAIRER, "99");
    }};
}
