...
public interface Constant {
    ...
    String INVALID_SUB_SERVICE_ID = "INVALID_SUB_SERVICE_ID";
    String INVALID_ACCESSORY_ID = "INVALID_ACCESSORY_ID";
    String DUPLICATE_SUB_SERVICE_ID = "DUPLICATE_SUB_SERVICE_ID";
    String DUPLICATE_ACCESSORY_ID = "DUPLICATE_ACCESSORY_ID";
    String ADD_SUB_SERVICE_TO_INVOICE_SUCCESS = "ADD_SUB_SERVICE_TO_INVOICE_SUCCESS";
    String ADD_ACCESSORIES_TO_INVOICE_SUCCESS = "ADD_ACCESSORIES_TO_INVOICE_SUCCESS";
    String ADD_EXTRA_SERVICE_TO_INVOICE_SUCCESS = "ADD_EXTRA_SERVICE_TO_INVOICE_SUCCESS";
